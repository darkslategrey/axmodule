...
class InterfaceMyTrigger
{
    ...
    function __construct($db)
    {
        ...
        $this->family = "axmodule";
        $this->description = "Specific triggers to axmodule";
	...
	// Actions
	  ...
	  if ($resql) {
        ...
        {
	  dol_syslog("Trigger '".$this->name."' for action '$action' launched by ".__FILE__.". id=".$object->id);
	  /* dol_syslog("axmodule trigger contact modify ".print_r($action, true), LOG_DEBUG); */
	  /* dol_syslog("axmodule trigger contact modify ".print_r($object, true), LOG_DEBUG); */
	  /* dol_syslog("axmodule trigger contact modify ".print_r($user, true), LOG_DEBUG); */
	  /* dol_syslog("axmodule trigger contact modify ".print_r($lang, true), LOG_DEBUG); */
	  /* dol_syslog("axmodule trigger contact modify ".print_r($con, true), LOG_DEBUG); */
        }
