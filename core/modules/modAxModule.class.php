 ...
 *				Such a file must be copied into htdocs/axmodule/core/modules directory.
 *  \file       htdocs/axmodule/core/modules/modAxmodule.class.php
 *  \ingroup    mymodule
 ...
 */
class modAxModule extends DolibarrModules
{
	/**
	...
	function __construct($db)
	{
		...
		$this->description = "AxModule Specific Module";
		...
		$this->module_parts = array(
					    ...
					    'hooks' => array('thirdpartycard', 'thirdpartydao', 'index', 'contactcard', 'contactdao'),
